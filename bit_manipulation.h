...
namespace bit_manipulation
{
	 ...
	 *	{ 0 <= pos < ui64_size }
	\*/
	bool getBit(ui64 src, std::size_t pos); // non c'� necessit� di usare template qui, ritorna sempre 0 o 1.
	...
	{
		assert( // mi assicuro che leftBound non sia pi� grande di quanto possibile dal tipo
